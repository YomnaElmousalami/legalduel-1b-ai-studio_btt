...
- [References and Libraries used](#references)
...
- Mainly for the Exploratory Data Analysis portion (as seen in the table of contents): OpenAI. (2024). ChatGPT (October 2024 version) [Large language model]. https://chat.openai.com/chat
- Some Timeline Assistance: w3schools. (n.d.). How TO - Timeline. How To Create a Timeline. https://www.w3schools.com/howto/howto_css_timeline.asp 
